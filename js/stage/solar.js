...
/* [hora, céu topo/meio/base, nebulosa+amp, glow horizonte céu+amp, brilho
   estrelas, amb1, amb2, horizonte CSS] — âncoras 2h e 26h fecham o ciclo */
const K=[
  [2  ,hx('#04030b'),hx('#090616'),hx('#110a22'),hx('#8b5cf6'),.045,hx('#d946ef'),.03,1  ,[76,29,149,.10]  ,[30,58,138,.10]  ,[249,115,22,0]  ],
  [6  ,hx('#060a18'),hx('#0b1228'),hx('#182342'),hx('#3b82f6'),.05 ,hx('#fb923c'),.06,.9 ,[67,56,202,.12]  ,[30,64,175,.10]  ,[251,146,60,.03]],
  [9  ,hx('#070713'),hx('#0e0c20'),hx('#221a3a'),hx('#a78bfa'),.06 ,hx('#fbbf24'),.07,.55,[139,92,246,.15] ,[251,191,36,.09] ,[251,146,60,.08]],
  [13 ,hx('#08060f'),hx('#100b1e'),hx('#1d1432'),hx('#936bff'),.07 ,hx('#fbbf24'),.02,.55,[147,107,255,.22],[240,171,252,.13],[251,146,60,0]  ],
  [16.5,hx('#080611'),hx('#120c20'),hx('#221334'),hx('#a78bfa'),.06 ,hx('#fb923c'),.04,.55,[139,92,246,.18] ,[244,114,182,.10],[251,146,60,.03]],
  [18.5,hx('#0a0612'),hx('#150c20'),hx('#2c1630'),hx('#f59e0b'),.05 ,hx('#fb923c'),.12,.62,[150,95,235,.17] ,[249,164,63,.12] ,[251,146,60,.10]],
  [20 ,hx('#070512'),hx('#120a1e'),hx('#2a102e'),hx('#f472b6'),.055,hx('#f97316'),.14,.78,[168,85,247,.16] ,[244,114,182,.12],[249,115,22,.13]],
  [22 ,hx('#050410'),hx('#0a0718'),hx('#150d26'),hx('#a78bfa'),.05 ,hx('#d946ef'),.05,1  ,[139,92,246,.16] ,[240,171,252,.10],[217,70,239,.05]],
  [26 ,hx('#04030b'),hx('#090616'),hx('#110a22'),hx('#8b5cf6'),.045,hx('#d946ef'),.03,1  ,[76,29,149,.10]  ,[30,58,138,.10]  ,[249,115,22,0]  ],
];
...
export function sampleSolar(hour,wx){
  ...
  return{top,mid,bot,neb,nebAmp,horGl,horAmp,glow,
