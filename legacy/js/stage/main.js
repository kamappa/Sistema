...
function init(tier){
  ...
  window.Stage={tier,engine,debug:{
    ...
    world(){return{hour:world.hour,pace:world.pace,glow:world.glow,arc:world.arc,recovery:world.recovery,presence:world.presence,core:world.core,neglect:world.neglect,sunday:world.sunday};},
  }};
